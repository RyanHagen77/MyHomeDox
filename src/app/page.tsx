      ...
      <main className="relative min-h-screen text-white">
            ...
            <div className="ml-auto flex items-center gap-2 basis-full sm:basis-auto sm:ml-auto">
              ...
              <div className="relative w-full sm:w-auto">
                <details className="group">
                  <summary
                      className="list-none cursor-pointer select-none rounded-full bg-white px-3 py-1.5 text-center text-sm text-slate-900 hover:bg-white/90">
                    Pro Login
                  </summary>
        ...
        <section className="px-4 pt-8 md:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <div
                className="mb-4 inline-flex overflow-hidden rounded-full border border-white/20 bg-white/10 p-0.5 backdrop-blur-sm">
              <button
                  onClick={() => setAud("home")}
